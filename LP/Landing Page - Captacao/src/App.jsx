// App.jsx — Composição da página. Compartilhado entre:
//   • src/main.jsx           — cliente (hidrata o HTML pré-renderizado)
//   • src/prerender-entry.jsx — build (renderToString → index.html)
// Por isso NADA aqui pode acessar window/document fora de handlers/effects.
